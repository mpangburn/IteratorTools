...
public extension Sequence {
    ...
    /**
     Returns an array containing the combinations of elements in the sequence of the specified length.
     ```
    ...
    /**
     Returns an array containing the combinations of elements in the sequence of the specified length, with replacement (i.e. elements can repeat).
     ```
     let values = [1, 2, 3, 4].combinations(length: 2)
...
/// An iterator-sequence that returns the combinations of elements in a sequence. 
